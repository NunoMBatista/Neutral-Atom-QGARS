...
\begin{figure}[!tb]
    ...
    \resizebox{\columnwidth}{!}{%
        \begin{circuitikz}
            ...
            \draw(8,12.25) rectangle  node {\Huge $f_{\theta}(\mathbf{x})$} (10.5,9.75);
            ...
            \draw(17.75,12.25) rectangle  node {\Huge $g_{\phi}(\mathbf{z})$} (20.25,9.75);
            ...
            \node[font=\LARGE] at (23,12.25) {$\mathbf{\hat{x}}$};
